                        ...
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            <div>
                                ...
                                <input type="text" name="latitude" id="latitude"
                                    value="{{ old('latitude', $person->latitude) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="longitude" id="longitude"
                                    value="{{ old('longitude', $person->longitude) }}"
                                    class="w-full border-gray-200 rounded text-sm font-mono text-center focus:ring-primary focus:border-primary">
                            </div>
                        </div>
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="first_name" class="block text-sm font-bold text-gray-700">الاسم <span
                            ...
                            <div>
                                ...
                                <input type="text" name="mother_name" id="mother_name"
                                    value="{{ old('mother_name', $person->mother_name) }}"
                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm">
                            </div>
                            <div>
                                ...
                                <select name="gender" id="gender"
                                    ...
                                    <option value="ذكر" {{ old('gender', $person->gender) == 'ذكر' ? 'selected' : '' }}>
                                        ذكر</option>
                                    <option value="أنثى" {{ old('gender', $person->gender) == 'أنثى' ? 'selected' : '' }}>
                                        أنثى</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="marital_status" id="marital_status"
                                    ...
                                    <option value="أعزب/عزباء" {{ old('marital_status', $person->marital_status) == 'أعزب/عزباء' ? 'selected' : '' }}>أعزب/عزباء</option>
                                    <option value="متزوج/متزوجة" {{ old('marital_status', $person->marital_status) == 'متزوج/متزوجة' ? 'selected' : '' }}>متزوج/متزوجة
                                    </option>
                                    <option value="مطلق/مطلقة" {{ old('marital_status', $person->marital_status) == 'مطلق/مطلقة' ? 'selected' : '' }}>مطلق/مطلقة</option>
                                    <option value="أرمل/أرملة" {{ old('marital_status', $person->marital_status) == 'أرمل/أرملة' ? 'selected' : '' }}>أرمل/أرملة</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="date" name="dob" id="dob" value="{{ old('dob', $person->dob) }}"
                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="country" id="country" onchange="handleCountryChange()"
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary sm:text-sm">
                                ...
                                <div id="tunisia-regions" class="grid grid-cols-1 md:grid-cols-3 gap-4 md:col-span-2">
                                    <div>
                                        <label class="block text-sm font-bold text-gray-700 mb-1">الولاية
                                            (Gouvernorat)</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-bold text-gray-700 mb-1">المعتمدية
                                            (Délégation)</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-bold text-gray-700 mb-1">العمادة
                                            (Secteur/Imada)</label>
                            ...
                            <div class="md:col-span-2">
                                <label for="address" class="block text-sm font-bold text-gray-700">العنوان الحالي
                                    بالتفصيل</label>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="level" class="block text-sm font-bold text-gray-700">المستوى
                                        الدراسي</label>
                                    <input type="text" name="level" id="level"
                                        value="{{ old('level', $person->level) }}"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm">
                                </div>
                                <div>
                            ...
                            <div>
                                <label for="social" class="block text-sm font-bold text-gray-700">حسابات التواصل
                                    الاجتماعي</label>
                                <textarea name="social" id="social" rows="2" dir="ltr"
                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm text-left font-mono">{{ old('social', $person->social) }}</textarea>
                            </div>
                            <div>
                                <label for="notes" class="block text-sm font-bold text-gray-700 mb-2">ملاحظات إدارية
                                    وأمنية هامة</label>
                                <div id="editor-container" class="bg-white" style="height: 200px;"></div>
                                <textarea name="notes" id="notes"
                                    class="hidden">{{ old('notes', $person->notes) }}</textarea>
                            </div>
                        </div>
                    </div>
