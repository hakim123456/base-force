<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div
                class="md:col-span-1 border border-gray-100 bg-white rounded-xl shadow-sm p-6 flex flex-col items-center">
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-6 text-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <span class="block text-gray-400 font-bold mb-1">العنوان الحالي (بالتفصيل)</span>
                ...
                <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-6 text-sm">
                    <div class="flex justify-between items-center border-b border-gray-100 pb-3 mb-4">
                        ...
                        @if($person->latitude && $person->longitude)
                            <a href="https://www.google.com/maps/search/?api=1&query={{ $person->latitude }},{{ $person->longitude }}"
                                target="_blank"
                                class="px-3 py-1 bg-green-100 text-green-700 hover:bg-green-200 rounded text-xs font-bold transition flex items-center">
                    ...
                    @else
                        <div
                            class="py-10 text-center text-gray-500 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                ...
                <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-6 text-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-gray-800 border-r-2 border-primary pr-3 py-1 bg-blue-50/20">
                                {{ $person->religion ?? '-' }} <br> {{ $person->dawah ?? '' }}
                            </p>
                        </div>
                        <div>
                ...
                @if($person->notes)
                    <div
                        class="bg-yellow-50 border border-yellow-200 rounded-xl shadow-sm p-6 text-sm relative overflow-hidden">
    ...
    <style>
        /* Adjusting Quill styles for the show page */
        .ql-editor {
            direction: rtl;
            text-align: right;
            font-family: inherit;
